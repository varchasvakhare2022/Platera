...
import { Loader2, ArrowRight, AlertCircle, ChefHat, Mail } from 'lucide-react';
...
export default function SignUpPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setErrors({ form: err.errors[0].longMessage });
        } finally {
            setLoading(false);
        }
    };
                    ...
                    {!pendingVerification ? (
                        <>
                            ...
                            <div className="text-center mb-6">
                                <h1 className="text-2xl font-bold text-white mb-1.5 tracking-tight font-display">Join Platera</h1>
                                <p className="text-stone-400 text-xs">Create your profile and start sharing</p>
                            </div>
                            ...
                            <div className="relative mb-6">
                                ...
                                <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                                    <span className="bg-[#0A0A0A] px-2 text-stone-600">Or sign up with email</span>
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest ml-1">First Name</label>
                                        <input
                                            type="text"
                                            ...
                                            placeholder="Gordon"
                                        />
                                        {errors.firstName && <p className="text-red-500 text-[10px] ml-1 font-medium">{errors.firstName}</p>}
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest ml-1">Last Name</label>
                                        <input
                                            type="text"
                                            ...
                                            placeholder="Ramsay"
                                        />
                                        {errors.lastName && <p className="text-red-500 text-[10px] ml-1 font-medium">{errors.lastName}</p>}
                                    </div>
                                </div>
                            ...
                            <div className="mt-6 pt-4 border-t border-stone-900 text-center text-xs text-stone-500">
                                ...
                                <Link href="/sign-in" className="text-white hover:text-[#FF6A00] font-medium transition-colors">
                                    Sign in
                                </Link>
                            </div>
                        </>
                        ...
                        <div className="text-center">
                            ...
                            <h2 className="text-xl font-bold text-white mb-1.5 font-display">Check your email</h2>
