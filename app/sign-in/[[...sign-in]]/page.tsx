...
export default function SignInPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const result = signInSchema.safeParse({ identifier: cleanIdentifier, password: cleanPassword });
            ...
            >
                <div className="bg-[#0A0A0A] border border-stone-800/60 rounded-2xl p-6 backdrop-blur-xl shadow-2xl">
                    ...
                    <div className="text-center mb-6">
                        <h1 className="text-2xl font-bold text-white mb-1.5 tracking-tight font-display">Welcome Back</h1>
                        <p className="text-stone-400 text-xs">Sign in to continue your culinary journey</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        ...
                        >
                            ...
                            <span className="text-white text-xs font-medium group-hover:text-white/90">Google</span>
                        </button>
                        <button
                            type="button"
                            onClick={() => signIn?.authenticateWithRedirect({
                        ...
                        >
                            ...
                            <span className="text-white text-xs font-medium group-hover:text-[#5865F2]">Discord</span>
                        </button>
                    </div>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                            <span className="bg-[#0A0A0A] px-2 text-stone-600">Or continue with email</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {errors.form && (
                            <motion.div
                                ...
                                className="bg-red-500/5 border border-red-500/20 rounded-xl p-4 flex items-center gap-3 text-red-500 text-sm overflow-hidden"
                            >
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-stone-500 uppercase tracking-widest ml-1">Email or Username</label>
                            <div className="relative group">
                                <input
                                    type="text"
                                    value={identifier}
                                    onChange={(e) => setIdentifier(e.target.value)}
                                    className="w-full bg-[#111] border border-stone-800 rounded-xl px-4 py-3.5 text-white placeholder:text-stone-700 focus:outline-none focus:border-[#FF6A00]/40 focus:bg-[#161616] transition-all duration-300 caret-[#FF6A00]"
                                    placeholder="chef@platera.com or chef123"
                                />
                            </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <button type="button" className="text-xs text-stone-500 hover:text-[#FF6A00] transition-colors">Forgot?</button>
                            </div>
                            <div className="relative group">
                                <input
                                    ...
                                    className="w-full bg-[#111] border border-stone-800 rounded-xl px-4 py-3.5 text-white placeholder:text-stone-700 focus:outline-none focus:border-[#FF6A00]/40 focus:bg-[#161616] transition-all duration-300 caret-[#FF6A00] pr-10"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                        ...
                        <div className="pt-4">
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-[#FF6A00] hover:bg-[#FF8533] text-black font-bold py-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(255,106,0,0.15)] hover:shadow-[0_0_30px_rgba(255,106,0,0.3)] disabled:opacity-70 disabled:cursor-not-allowed group"
                            >
                                {loading ? (
                    ...
                    {/* Footer */}
                    <div className="mt-8 pt-6 border-t border-stone-900 text-center text-sm text-stone-500">
                        Don't have an account?{' '}
                        <Link href="/sign-up" className="text-white hover:text-[#FF6A00] font-medium transition-colors">
                            Create Profile
                        </Link>
                    </div>
                </div>
