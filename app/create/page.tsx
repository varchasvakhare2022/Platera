        ...
        <main className="min-h-screen bg-[#050505] text-stone-200 font-sans selection:bg-stone-800 selection:text-white pt-28 pb-24">
            <div className="container mx-auto max-w-4xl px-6">
                ...
                <div className="mb-10 text-center md:text-left">
                    ...
                    <h1 className="text-4xl font-bold text-white tracking-tight mb-2">Share Your Recipe</h1>
                    <p className="text-stone-500">Contribute your culinary masterpiece to the Platera community.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
                            ...
                            >
                                ...
                                {imagePreview ? (
                                    ...
                                    <div className="text-center p-6">
                                        ...
                                        <p className="text-stone-600 text-xs">JPG or PNG, max 5MB</p>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-7 space-y-6">
                            ...
                            {/* Description (Optional) */}
                            <div className="space-y-2">
                                <label className="block text-sm font-medium text-stone-400 uppercase tracking-wider">Short Description <span className="text-stone-600 normal-case tracking-normal">(Optional)</span></label>
                                <textarea
                                    value={description}
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs text-stone-500 uppercase tracking-wider">List all items needed</span>
                        </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs text-stone-500 uppercase tracking-wider">Step-by-step guide</span>
                        </div>
